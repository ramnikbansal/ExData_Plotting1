...
#
#--------------------
# Written to plot the plot-3 of the project
#--------------------
...
##### PLOT-3
png(filename = "plot3.png", width = 480, height = 480, bg = "white") # bg = "transparent" would produce exact png file as available as reference in the assignment but I am using "white" for better viewability of peers when they are viewing individual files
