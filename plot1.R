...
#
#--------------------
# Written to plot the plot-1 of the project
#--------------------
...
##### PLOT-1
png(filename = "plot1.png", width = 480, height = 480, bg = "white") # bg = "transparent" would produce exact png file as available as reference in the assignment but I am using "white" for better viewability of peers when they are viewing individual files
hist(smalldata[,3], xlab = "Global Active Power (Kilowatts)", col = "red", main = "Global Active Power")
dev.off()
